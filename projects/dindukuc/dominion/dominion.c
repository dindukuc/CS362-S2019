...
int adventurerCard(int drawntreasure, struct gameState *state, int currentPlayer, int temphand[], int cardDrawn, int z){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer: //adventurer start
      return adventurerCard(drawntreasure, state, currentPlayer, temphand, cardDrawn, z);//adventurer end
    ...
    case smithy: //smithy begin
      
      return smithyCard(state, currentPlayer, handPos, i);
      //smithy end
    case village:
